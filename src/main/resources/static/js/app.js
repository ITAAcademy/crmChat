...
var springChatControllers = angular.module('springChat.controllers', ['ngScrollGlue', 'angular-nicescroll', 'ngDialog', 'ngTagsInput', 'infinite-scroll', 'toaster', 'ngRoute', 'ngAnimate', 'ngResource', 'ngCookies', 'ngSanitize']);
