...
/* Controllers */
var springChatControllers = angular.module('springChat.controllers', ['ui.bootstrap','infinite-scroll','toaster','ngRoute', 'ngAnimate','ngResource','ngCookies', 'ngSanitize']);
